...
本篇记录 **2026-05-11～2026-05-17** 的输入、输出与思考。重点是 **Obsidian 第二大脑（second-brain）** 知识库搭建：以 [Hermes Agent](/briefs/20260412-week-review) 与 Telegram 为入口，用 Markdown、Agent Skill 和 PARA 目录整理个人知识，并梳理定时日推与注意力管理。
...
在使用 [Hermes Agent](/briefs/20260412-week-review) 的过程中，逐渐把 **Telegram + Hermes** 当作知识管理入口：有了 Agent Skill，许多自建 Docker 服务与独立 App 的必要性下降——在大模型加持下，用 Markdown 即可管理知识与信息。
