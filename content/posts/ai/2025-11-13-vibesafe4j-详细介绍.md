---
title: "Vibesafe4j 详解：用 AI 自动生成 Java 接口实现"
...
**[Vibesafe4j 使用 Annotation Processor 实现（编译时代码生成）](/posts/vibesafe4j-annotation-processor-implementation)**
...
- [Vibesafe4j 使用 Annotation Processor 实现（编译时代码生成）](/posts/vibesafe4j-annotation-processor-implementation) - 学习如何在编译时生成代码
- [Spring AI 介绍](/posts/spring-ai) - 了解 Spring AI 框架
