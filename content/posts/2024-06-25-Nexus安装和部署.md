---
title: "Docker 搭建本地 Maven 仓库：Nexus 安装与配置"
...
{
  "registry-mirrors" : [
    "https://docker-registry.zhijun.io"
  ]
}
```
...
5. 为 docker 注册中心配置反向代理
   ...
   server {
       listen 80;
       server_name docker-registry.zhijun.io;
       rewrite ^ https://$http_host$request_uri? permanent;
   }
...
<settings xsi:schemaLocation="http://maven.apache.org/SETTINGS/1.2.0 http://maven.apache.org/xsd/settings-1.2.0.xsd" xmlns="http://maven.apache.org/SETTINGS/1.2.0"
  ...
  <mirrors>     
    <mirror>  
        ...
        <url>https://nexus.zhijun.io/repository/maven-public/</url>  
    ...
    <profile>
      <repositories>
        <repository>
          ...
          <url>https://nexus.zhijun.io/repository/maven-release</url>
        </repository>
        <repository>
          <snapshots />
          <id>snapshots</id>
          <name>nexus-snapshot</name>
          <url>https://nexus.zhijun.io/repository/maven-snapshot</url>
        </repository>
      </repositories>
      <pluginRepositories>
        <pluginRepository>
...
```bash
docker login docker-registry.zhijun.io
```
...
接下来，试试从 docker-registry.zhijun.io 下载镜像

```bash
$ docker pull docker-registry.zhijun.io/alpine:3.16
3.16: Pulling from alpine
Digest: sha256:452e7292acee0ee16c332324d7de05fa2c99f9994ecc9f0779c602916a672ae4
Status: Downloaded newer image for docker-registry.zhijun.io/alpine:3.16
docker-registry.zhijun.io/alpine:3.16
```

从日志可以看到是从 docker-registry.zhijun.io 下载镜像，并且在 <https://nexus.zhijun.io/#browse/browse:docker> 可以看到下载的镜像。

推送镜像：

```bash
$ docker tag alpine:3.16 docker-registry.zhijun.io/alpine:3.16-custom

$ docker push docker-registry.zhijun.io/alpine:3.16-custom
The push refers to repository [docker-registry.zhijun.io/alpine]
edbfd2db8ef2: Pushed
