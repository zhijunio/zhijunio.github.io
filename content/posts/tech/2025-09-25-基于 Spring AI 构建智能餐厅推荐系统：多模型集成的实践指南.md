---
title: "Spring AI 实战：多模型集成的智能餐厅推荐系统"
...
|---------|-----------|---------|--------|----------|
| `.entity()` | 5/5 | 5/5 | 3/5 | 简单对象 |
| `ParameterizedTypeReference` | 4/5 | 5/5 | 4/5 | 复杂泛型 |
| `BeanOutputConverter` | 3/5 | 4/5 | 5/5 | 自定义转换 |
| `MapOutputConverter` | 3/5 | 2/5 | 5/5 | 动态结构 |
| `ListOutputConverter` | 3/5 | 2/5 | 4/5 | 简单列表 |
