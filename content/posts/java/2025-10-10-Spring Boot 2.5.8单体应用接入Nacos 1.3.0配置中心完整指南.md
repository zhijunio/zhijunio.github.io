---
title: "Spring Boot 2.5.8 接入 Nacos 1.3.0 配置中心：3 种方案"
...
|------|---------------------|----------|---------------|----------|
| 方案一 | 2.4.x / 2.6.x / 2.7.x | Spring Cloud Alibaba 2021.0.1.0 | 1.3.0+ | 5/5 |
| 方案二 | 2.3.12 | Spring Cloud Alibaba 2.2.6.RELEASE | 1.3.0+ | 4/5 |
| 方案三 | 2.5.8 | Nacos Spring Context 1.1.2 | 1.3.0+ | 5/5 |
